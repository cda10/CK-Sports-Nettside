...
export default function StudioPage() {
  return (
    <section className="mx-auto max-w-[1100px] px-5 pt-32 pb-24 lg:px-10 lg:pt-40 lg:pb-28">
      ...
      <h1 className="font-[family-name:var(--font-ck-display)] text-[40px] leading-tight font-medium text-[#1f3a4d] lg:text-[56px]">
        SoMe-generator
      </h1>
      <p className="mt-5 max-w-xl text-[18px] leading-relaxed text-[#1f3a4d]/70">
